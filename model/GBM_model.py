...
# Standardize features (GBM does not require it, but it helps with stability)
...
for fold, (train_idx, val_idx) in enumerate(cv.split(train_data)):
    ...
    model = GradientBoostingClassifier(n_estimators=100, learning_rate=0.1, max_depth=5, random_state=18)
